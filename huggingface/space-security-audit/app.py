...
def run_audit(preset_name: str, budget: int, num_genes: int) -> str:
    ...
    if damages:
        ...
        scan_html = (
            ...
            f"<th scope=\'col\' style='padding:6px 8px;text-align:left;'>Type</th>"
            f"<th scope=\'col\' style='padding:6px 8px;text-align:left;'>Severity</th>"
            f"<th scope=\'col\' style='padding:6px 8px;text-align:left;'>Location</th>"
            f"<th scope=\'col\' style='padding:6px 8px;text-align:left;'>Description</th>"
            f"</tr>{rows}</table>"
        )
    else:
        scan_html = (
...
def verify_all_certificates(budget: int) -> str:
    ...
    inner = (
        ...
        f"<table style='width:100%;border-collapse:collapse;font-size:0.9em;'>"
        f"<tr style='background:#e5e7eb;'>"
        f"<th scope=\'col\' style='padding:8px;text-align:left;'>Theorem</th>"
        f"<th scope=\'col\' style='padding:8px;text-align:left;'>Source</th>"
        f"<th scope=\'col\' style='padding:8px;text-align:left;'>Status</th>"
        f"<th scope=\'col\' style='padding:8px;text-align:left;'>Evidence</th>"
        f"</tr>{rows}</table>"
