...
def _fact_row_html(f, show_status=True):
    ...
    return (
        ...
        f'<td style="padding:6px;font-size:0.85em">{_day_fmt(f.valid_from)} <span aria-hidden="true">&mdash;</span> {valid_to}</td>'
        f'<td style="padding:6px;font-size:0.85em">{_day_fmt(f.recorded_from)} <span aria-hidden="true">&mdash;</span> {rec_to}</td>'
...
def _fact_table_html(facts, title="Facts", show_status=True):
    ...
    header = (
        ...
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">ID</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db">Status</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Subject</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Predicate</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Value</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Valid Time</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Record Time</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db;text-align:left">Source</th>'
        '<th scope="col" style="padding:6px;border-bottom:2px solid #d1d5db">Tags</th>'
        '</tr>'
    )
