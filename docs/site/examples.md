...
- [`examples/67_pattern_first_api.py`](https://github.com/coredipper/operon/blob/main/examples/67_pattern_first_api.py) — shortest path into the public wrappers
- [`examples/68_skill_organism_runtime.py`](https://github.com/coredipper/operon/blob/main/examples/68_skill_organism_runtime.py) — practical multi-model runtime
- [`examples/71_bitemporal_skill_organism.py`](https://github.com/coredipper/operon/blob/main/examples/71_bitemporal_skill_organism.py) — substrate integration with belief-state reconstruction
- [`examples/72_pattern_repository.py`](https://github.com/coredipper/operon/blob/main/examples/72_pattern_repository.py) — register, score, and retrieve reusable pattern templates
- [`examples/73_watcher_component.py`](https://github.com/coredipper/operon/blob/main/examples/73_watcher_component.py) — runtime monitoring with signal classification and interventions
- [`examples/74_adaptive_assembly.py`](https://github.com/coredipper/operon/blob/main/examples/74_adaptive_assembly.py) — adaptive assembly loop with template selection and outcome recording
- [`examples/75_experience_driven_watcher.py`](https://github.com/coredipper/operon/blob/main/examples/75_experience_driven_watcher.py) — experience pool driving intervention recommendations
- [`examples/76_cognitive_modes.py`](https://github.com/coredipper/operon/blob/main/examples/76_cognitive_modes.py) — System A/B cognitive mode annotations
- [`examples/77_sleep_consolidation.py`](https://github.com/coredipper/operon/blob/main/examples/77_sleep_consolidation.py) — sleep consolidation cycle with counterfactual replay
- [`examples/78_social_learning.py`](https://github.com/coredipper/operon/blob/main/examples/78_social_learning.py) — cross-organism template sharing with trust
- [`examples/79_curiosity_driven_exploration.py`](https://github.com/coredipper/operon/blob/main/examples/79_curiosity_driven_exploration.py) — curiosity-driven escalation
- [`examples/66_epistemic_topology.py`](https://github.com/coredipper/operon/blob/main/examples/66_epistemic_topology.py) — epistemic analysis layer underneath

## Full Example Index

Use the repo index for the broader catalog:

- [Examples README](https://github.com/coredipper/operon/blob/main/examples/README.md)

## Suggested Categories

- Pattern-first API
- Skill organisms and runtime composition
- Bi-temporal memory and substrate integration
- Epistemic topology
- Wiring diagrams and lower-level structure
