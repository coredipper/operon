...
- `v0.24` added convergence adapters (Swarms, DeerFlow, AnimaWorks, Ralph, A-Evolve), TLA+ formal verification, co-design composition — the convergence layer (C1–C4)
- `v0.24.1` added Scion adapter, production compilers (organism_to_swarms/deerflow/ralph/scion), distributed watcher, LangGraph node — phase C5
