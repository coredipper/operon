...
The biological system pays a throughput cost for this guarantee.  Under
bursty load, it completed 71.9\% of all operations versus the naive
counter's 68.5\%---a 3.4 percentage-point improvement.  Under gradual
depletion, the relationship inverts slightly: biological completed
97.9\% versus ablated's 99.6\%, because the MTORScaler's anticipatory
conservation gates some non-critical operations that ATP\_Store alone
would have served.  This is the intended tradeoff: the biological system
trades marginal throughput for guaranteed critical service.
