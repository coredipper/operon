...
A composition non-interference experiment validates Ma et~al.'s
claim~\cite{ma2026atomic}: composing localize$\to$edit$\to$test as a
serial pipeline does not degrade overall quality ($\Delta = +0.029$
vs individual skills), though harder tasks (TOCTOU race conditions)
show negative interference ($\Delta = -0.167$).
