...
also improves total throughput (71.9\% vs 68.5\%); against the ablated
control, the mTOR scaler trades 1.7 percentage points of throughput
for guaranteed critical service via feature gating.
