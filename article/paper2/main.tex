...
\paragraph{Epiplexity: honest negative.}
The naive cosine-similarity detector outperformed the biological
Bayesian two-signal design on detection accuracy across all scenarios,
including pathway-grounded trophic-withdrawal tests.  However, the
biological variant achieved 0\% false-positive rate (vs.\ naive 75\%
FP on loops) at the cost of 58\% false negatives.  With mock
embeddings rather than real LLM outputs, the two-signal advantage
