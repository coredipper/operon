...
\texttt{feedback\_fixed\_point()} terminates when
$|s_{n+1} - s_n| < \varepsilon$ (default $0.01$), providing
$\varepsilon$-approximate convergence, with a safety bound of 100
iterations to handle non-stabilizing sequences.
\end{proof}
