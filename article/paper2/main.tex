...
external agent configurations without importing the target framework.  Five adapters parse framework-specific configurations into this
...
loop converges within $\varepsilon$.  The architecture is implemented in 22
convergence modules with 300 convergence-specific tests as part of a broader
suite of 1{,}510 tests and 106 worked examples.
\end{abstract}
...
The convergence architecture is implemented in 22 Python modules under
\texttt{operon\_ai/convergence/}, tested by 300 convergence-specific unit
tests as part of a broader suite of 1{,}510 tests across the entire Operon
...
(nested dicts remain mutable by Python convention).  The 22 convergence modules, 300 convergence tests, 4 TLA+
specifications, and 106 worked examples provide a concrete, verifiable
