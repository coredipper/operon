...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Epistemic bounds as structural linter}: error
    amplification, sequential penalty, parallel acceleration, and tool
    density bounds are applied uniformly to every imported topology.
...
four epistemic bounds, generates structural warnings, and optionally
