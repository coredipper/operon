...
Full certificate identity (theorem + parameters + source) is preserved across all four topology-preserving compilers, confirming Proposition~5.1 empirically. The LangGraph wrapper additionally preserves all certificates via internal enforcement (Section~\ref{sec:preservation}).
