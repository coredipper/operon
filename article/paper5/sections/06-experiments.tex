...
The correspondence is implemented in the Operon framework (\texttt{operon-ai}, MIT license), with 1{,}875 unit tests across the full stack. Key components:
...
Full certificate identity (theorem + parameters + source) is preserved across all compilers, confirming Proposition~5.1 empirically.
