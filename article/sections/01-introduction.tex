...
cell, thousands of genes operate as autonomous functional units, each reading local chemical signals (context)
and expressing proteins (actions/tools) that regulate other genes. The cell itself---the composite of these
genes plus shared infrastructure (organelles, membrane)---is the autonomous agent.
...
composable, with parallel/sequential composition and bisimulation-based equivalence checking.
...
penalty, parallel acceleration, tool density), validated against empirical results.
