...
consumes any \texttt{ExternalTopology} and applies the four epistemic theorems
(Theorems~\ref{thm:error-amplification}--\ref{thm:tool-density}) to produce
topology advice, a suggested \texttt{PatternTemplate}, structural warnings, and
a composite risk score. Adding a new orchestration target therefore requires
