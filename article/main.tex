necolor{codegray}{rgb}{0.5,0.5,0.5}
...
% Python Style
\definecolor{codegreen}{rgb--- Bibliography ---
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick, fill=blue!10] (0,1) arc (180:0:1.5) -- cycle;
        \node at (1.5, 1.5) {\textbf{Output} $o \in O$};
        
        % The Stalks (Inputs/Directions)
        \draw[thick] (0.5, 1) -- (0.5, 0) node[below] {$i_1 \in I_o$};
        \draw[thick] (1.5, 1) -- (1.5, 0) node[below] {$i_2 \in I_o$};
        \draw[thick] (2.5, 1) -- (2.5, 0) node[below] {$...$};
        
        % Box
        \node[draw, dashed, fit={(0,0) (3,2.5)}, label=below:\textit{The Interface $P(y)$}] {};
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        \node[below=0.2cm of agent, font=\small, color=gray] {Category $\Poly$};
        \node[below=0.2cm of gene, font=\small, color=gray] {Category $\Poly$};
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        % Annotations
        \node[above=0.1cm of assessor, font=\tiny, color=gray] {Type: Check};
        \node[below=0.1cm of executor, font=\tiny, color=gray] {Type: Gen};
